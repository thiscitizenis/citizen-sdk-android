...
public class VerifyTokenTask extends AsyncTask<Object, Void, Integer> {
    private static final String TAG = VerifyTokenTask.class.getSimpleName();

    public interface AsyncResponse {
        void verifyTokenTaskFinished(Integer statusCode, Token token);
    }
    ...
    public VerifyTokenTask(AsyncResponse delegate, TokenService tokenService) {
    ...
    protected Integer doInBackground(Object... params) {
        ...
        try {
            this.token = tokenService.verifyTokenSignature(token);
            if (this.token != null) {
    ...
    protected void onPostExecute(Integer statusCode) {
        delegate.verifyTokenTaskFinished(statusCode, token);
    }
}
